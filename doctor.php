...
html,body,h1,h2,h3,h4,h5,h6 {font-family: "Roboto", sans-serif}
    ...
    <script src="doctors/scripts/jquery-3.2.1.min.js">        
    </script>
    <script src="doctors/scripts/doctorsscr.js">
    </script>
    <link rel="stylesheet" href="doctors/w3.css">
</head>
		<?php
					...
					if($_POST['const']=='1'){
                        ...
                        if($test->errorF){
                            ...
                            if($SyncRep!=200){
                                ...
                                unset($test);
                                ob_start();
                                header("Location: doctors/LoggedIn/doc.php");
                                exit();
                            }
                        }
					}                    
