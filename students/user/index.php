...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="index.php" target="_top" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-users fa-fw"></i>  Overview</a>
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-bell fa-fw"></i>  News</a>
    <a href="table.php" target="_top" class="w3-bar-item w3-button w3-padding"><i class="fa fa-history fa-fw"></i>  History</a>
  ...
  <div class="w3-row-padding w3-margin-bottom">
    <div class="w3-half">
      <div class="w3-container w3-red w3-padding-16">
        <div class="w3-left"><i class="fa fa-toggle-up w3-xxxlarge"></i></div>
        <div class="w3-right">
          <h3><?php echo $_SESSION['height'] ?> cms.</h3>
        </div>
    ...
    <div class="w3-half">
      <div class="w3-container w3-blue w3-padding-16">
        ...
        <div class="w3-right">
          <h3><?php echo $_SESSION['weight'] ?> kgs.</h3>
        </div>
        <div class="w3-clear"></div>
        <h4>Weight</h4>
      </div>
    ...
    <div class="w3-half">
      <div class="w3-container w3-orange w3-text-white w3-padding-16">
        <div class="w3-left"><i class="fa fa-font w3-xxxlarge"></i></div>
        <div class="w3-right">
          <h3><?php echo $_SESSION['BGroup'] ?></h3>
        </div>
        <div class="w3-clear"></div>
        <h4>Blood Group</h4>
      </div>
